...
class MainActivity : Activity() {
    ...
    private fun startApp() {
        ...
        billing = BillingManager(applicationContext) { removed ->
            runOnUiThread {
                ...
                webView.evaluateJavascript("window.SpaceBala && window.SpaceBala.onAdsRemovedChanged($removed);", null)
            }
        }
    ...
    inner class GameBridge {
        ...
        @JavascriptInterface fun showRewarded() {
            ads.showRewarded { granted ->
                runOnUiThread {
                    webView.evaluateJavascript("window.SpaceBala && window.SpaceBala.onReward($granted);", null)
                }
            }
        }
    ...
    override fun onPause() {
        super.onPause()
        webView.evaluateJavascript("window.SpaceBala && window.SpaceBala.onPause();", null)
        webView.onPause()
    }
    ...
    override fun onResume() {
        super.onResume()
        webView.onResume()
        webView.evaluateJavascript("window.SpaceBala && window.SpaceBala.onResume();", null)
    }
